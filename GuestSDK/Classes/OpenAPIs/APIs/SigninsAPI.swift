...
open class SigninsAPI {
     ...
     */
    open class func createSignin(signinCreateParams: SigninCreateParams? = nil, apiResponseQueue: DispatchQueue = GuestSDKAPI.apiResponseQueue, completion: @escaping ((_ result: Swift.Result<Signin, Error>) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the result
     */
    open class func getSignin(signinId: String, include: String? = nil, apiResponseQueue: DispatchQueue = GuestSDKAPI.apiResponseQueue, completion: @escaping ((_ result: Swift.Result<SigninDetail, Error>) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the result
     */
    open class func updateSignin(signinId: String, signinUpdateParams: SigninUpdateParams, idempotencyKey: String? = nil, apiResponseQueue: DispatchQueue = GuestSDKAPI.apiResponseQueue, completion: @escaping ((_ result: Swift.Result<SigninDetail, Error>) -> Void)) {
