...
open class CapacitiesAPI {
     ...
     */
    open class func getCapacity(locationId: String, apiResponseQueue: DispatchQueue = GuestSDKAPI.apiResponseQueue, completion: @escaping ((_ result: Swift.Result<Capacity, Error>) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the result
     */
    open class func getCapacityForecast(locationId: String, hoursToForecast: Int? = nil, timestamp: String? = nil, apiResponseQueue: DispatchQueue = GuestSDKAPI.apiResponseQueue, completion: @escaping ((_ result: Swift.Result<CapacityForecast, Error>) -> Void)) {
